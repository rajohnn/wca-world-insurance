jQuery(function(){
	...
	jQuery("#cfgen-element-3-16").datepicker(jQuery.datepicker.regional["en-GB"]);
	jQuery("#cfgen-element-3-16").datepicker("option", "changeMonth", true);
	jQuery("#cfgen-element-3-16").datepicker("option", "changeYear", true);
	jQuery("#cfgen-element-3-16").datepicker("option", "firstDay", 1);
	jQuery("#cfgen-element-3-16").datepicker("option", "dateFormat", "mm/dd/y");
	jQuery("#cfgen-element-3-16").datepicker("option", "yearRange", "-70:+70");
